...
if( !class_exists( 'Overlap_Walker_MegaMenu_Nav' ) ){

    class Overlap_Walker_MegaMenu_Nav extends Walker_Nav_Menu
    {
...
if( !class_exists( 'Overlap_Walker_OnePage_Nav' ) ) {  
     
    class Overlap_Walker_OnePage_Nav extends Walker_Nav_Menu{
...
if( !class_exists( 'Overlap_Walker_Vertical_Nav' ) ) {  
     
    class Overlap_Walker_Vertical_Nav extends Walker_Nav_Menu{
        
        function start_lvl( &$output, $depth = 0, $args = array() ) {
            $output .= "\n<ul class=\"sub-menu\">\n";
            $output .= "\n<li class=\"back-to-parent\"><span>". esc_html__('Back', 'overlap') ."</span></li>\n";
        }
...
if( !class_exists( 'Overlap_Walker_OnePage_Vertical_Nav' ) ) {  
     
    class Overlap_Walker_OnePage_Vertical_Nav extends Walker_Nav_Menu{
