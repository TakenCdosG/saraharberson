...
<div<?php echo overlap_get_attributes( $attrs );?>>
    <?php echo do_shortcode( sprintf('[wyde_donut_chart value="%s" label_style="%s" label="%s" icon_set="%s" icon="%s" icon_typicons="%s" icon_linecons="%s" icon_bigmug_line="%s" icon_simple_line="%s"  style="%s" bar_color="%s" bar_border_color="%s" fill_color="%s" start="%s" type="half"]',
            esc_attr( $value ), 
