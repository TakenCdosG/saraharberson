<?php
    ...
    if ( isset( $google_fonts_data['values']['font_family'] ) ) {
        ...
        overlap_add_body_style('google_fonts_' . vc_build_safe_css_class( $google_fonts_data['values']['font_family'] ), '//fonts.googleapis.com/css?family=' . urlencode( $google_fonts_data['values']['font_family'] . $subsets ));
    }
