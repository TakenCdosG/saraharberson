...
<figure>
    <div class="post-media">
        ...
        <?php  
            ...
            ?>
            <div class="cover-image" style="background-image: url('<?php echo esc_url( $cover_image_url );?>');"><a href="<?php echo esc_url( get_permalink() );?>"></a></div>
            <?php   
            if( is_array($images) ): 
            ...
            ?>
            <div class="cover-image" style="background-image: url('<?php echo esc_url( $gallery_image[0] );?>');"><a href="<?php echo esc_url( get_permalink() );?>"></a></div>
            <?php   }
                endforeach; 
            endif; 
            ?>
